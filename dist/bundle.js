...
exports.default = (0, _reactRedux.connect)(mapStateTopProps)(Card);
    ...
    _createClass(Options, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                !canDelete ? null : _react2.default.createElement(
                    "div",
                    null,
                    _react2.default.createElement(
                        "h4",
...
var Photos = function (_Component) {
  ...
  _createClass(Photos, [{
    ...
    value: function render() {
      ...
      var album = this.props.album;
      var canDelete = this.props.user.canDelete;
...
function signInUser(_ref) {
    ...
    return function (dispatch) {
        _axios2.default.post(baseUrl + "signin", { email: email.toLowerCase(), password: password }).then(function (res) {
            _setLocalstorage([{ key: "token", value: res.data.token }, { key: "customer", value: true }, { key: "isAdmin", value: res.data.isAdmin }, { key: "canWrite", value: res.data.canWrite }, { key: "canDelete", value: res.data.canDelete }]);
            dispatch({
                type: _actiontypes.USER_AUTH,
                payload: {
                    authenticated: true,
