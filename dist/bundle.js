...
function photoDelete(albumId, photoId, filename, cb) {
    ...
    var albums = _axios2.default.delete(baseUrl, { data: { albumId: albumId, photoId: photoId, filename: filename } }).then(function (_) {
        cb();
    });
...
function mapDispatchToProps(dispatch) {
  return (0, _redux.bindActionCreators)({ albumsFetch: _albums.albumsFetch }, dispatch);
}
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement("input", { className: "small-input", type: "text", onTouchStart: function onTouchStart(_) {
  ...
  _createClass(Photos, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement("i", { className: "fa fa-share-alt button-icon" }),
        ...
        _react2.default.createElement(
          ...
          this.props.album.photos.map(function (photo, index) {
            return _react2.default.createElement(
              ...
              " ",
              _react2.default.createElement("img", { src: photo.medium })
            );
          })
        )
      );
...
function mapDispatchToProps(dispatch) {
  return (0, _redux.bindActionCreators)({ albumFetch: _albums.albumFetch, deleteAlbum: _albums.deleteAlbum }, dispatch);
}
