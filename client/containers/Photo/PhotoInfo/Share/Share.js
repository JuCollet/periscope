...
import { photoShare } from "../../../../actions/photos";
        ...
        return(
            <div>
                ...
                <form onSubmit={this.handleSubmit}>
                    ...
                    <textarea name="message" onChange={this.onInputChange} value={this.state.message} rows="3" className="small-input margin-md-bottom"></textarea>
