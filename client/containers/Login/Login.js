...
class LogIn extends Component {
    ...
    onSubmit(data){
        this.props.userLogin(data, _ => {this.props.history.push('/gallery')});
    }
        ...
        return (
            <div id="sign-wrapper">
                <form id="sign" onSubmit={handleSubmit(this.onSubmit)}>
                    ...
                    <Field className="margin-md-bottom" name="username" type="text" placeholder="Login" aria-label="username" component={this.renderField} />
                    <Field className="margin-lg-bottom" name="password" type="password" placeholder="Password" aria-label="password" component={this.renderField} />
